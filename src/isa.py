...
class Opcode(str, Enum):
    ...
    JZ = "jz"
    HLT = "hlt"
    # псевдоинструкция для хранения данных. выделяет блок в одно слово (32 бит) и заполняет укзаанным литералом / числом.
    # если используется как `var 'длинная строка'`, то создает  |s| слов в памяти (32 |s| бит)
    VAR = "var"
